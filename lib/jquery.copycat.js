!(function (root, factory) {
    ...
    function Copycat(element, target, options) {
        ...
        if (this._subtractScroll) {
            ...
            this._element.on('DOMMouseScroll', this._onMouseWheel);
            this._element.on('mousewheel', this._onMouseWheel);
        }
    ...
    Copycat.prototype.destroy = function (keepPosition) {
        ...
        this._element.off('DOMMouseScroll', this._onMouseWheel);
        this._element.off('mousewheel', this._onMouseWheel);
        ...
        this._element.removeData('_copy_cat');
    ...
    Copycat.prototype._onMouseWheel = function () {
    ...
    $.fn.copycat = function (target, options) {
        ...
        // .copycat(element, {})
            ...
            if (instance && instance._targetElement[0] !== target[0]) {
